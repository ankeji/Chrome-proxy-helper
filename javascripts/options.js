...
function save() {
    ...
    var proxySetting = JSON.parse(localStorage.proxySetting);
    proxySetting['http_host'] = $('#http-host').val() || "123.156.176.233";
    proxySetting['http_port'] = $('#http-port').val() || "4381";
    ...
    var pacType = proxySetting['pac_type'].split(':')[0];
    ...
    chrome.storage.sync.set({ 'proxySetting': settings }, function () { console.log('success') });
}
